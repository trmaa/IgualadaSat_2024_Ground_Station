...
function connect() {
  window.websocket = new WebSocket("ws://10.8.0.2:8001/");
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  connect();
    ...
    //FOLLOWING LINE IS JUST COMMENTED BECAUSE THIS IS A DUMMYMODE REPOSITORY
    //DOWNLOAD THE ADAPTED VERSION AT https://github.com/IgualadaSat TO USE AN ACTUAL IGUALADASAT
